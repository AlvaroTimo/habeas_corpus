...
# Recortar a solo el número correcto de columnas
df = df.iloc[:, :len(df.columns)]
print(f"Shape antes de eliminar columnas vacías: {df.shape}")
...
#print(nan_counts <= 80000)

# Eliminar columnas con más de 80,000 NaN
